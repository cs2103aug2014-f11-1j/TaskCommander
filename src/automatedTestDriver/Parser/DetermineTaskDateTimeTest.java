				...
				.asList(new Object[][] {
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime1 + " " + "anyString[1]", expectedDateTimes1 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
								...
								expectedDateTimes13 },
						{
								" " + inputDateTime1 + " " + "anyString[1]" + " "
										+ inputDateTime13, expectedDateTimes13 },
						{ inputDateTime1 + " " + "anyString[1]" + " " + inputDateTime13,
								expectedDateTimes13 },
						{
						...
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime2 + " " + "anyString[1]", expectedDateTimes2 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime3 + " " + "anyString[1]", expectedDateTimes3 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime4 + " " + "anyString[1]", expectedDateTimes4 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime5 + " " + "anyString[1]", expectedDateTimes5 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime6 + " " + "anyString[1]", expectedDateTimes6 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime7 + " " + "anyString[1]", expectedDateTimes7 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime8 + " " + "anyString[1]", expectedDateTimes8 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
										+ inputDateTime9 + " " + "anyString[1]", expectedDateTimes9 },
						{
								commandTypeWithOrWithoutIndex[0] + " " + anyString[0] + " "
	...
	public void testDetermineTaskDateTime() {
		...
		if (expectedDateTimes != null) {
			for (Date expectedDateTime : expectedDateTimes) {
				expectedResult += " " + Global.dayFormat.format(expectedDateTime) + " "
